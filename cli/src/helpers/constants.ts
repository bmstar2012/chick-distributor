...
// );
export const CHICK_DISTRIBUTOR_ID = new PublicKey(
  '3NHg4RvfmsqtUL9N8kryZNfdCcYqsS92BQQnmiQdEJpn'
);
export const CHICK_TEMPORAL_SIGNER = new PublicKey(
  '5hW2Y4KGNuo8Bh6ReD2D8VT3TTcBZSsxxJmnunvRmWc9'
);
